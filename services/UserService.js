...
class UserService {
  ...
  async deleteUser(userId) {
    try {
      const { data } = await axios.delete(
        `${store.baseUrl}/api/users/${userId}`
      );
      return data;
    } catch (error) {
      console.error(error);
  ...
  async findUserById(id) {
    try {
      const { data } = await axios.get(
        `${store.baseUrl}/api/users/find-one?id=${id}`
      );
      return data;
    } catch (error) {
      console.error(error);
  ...
  async findUserByTgId(id) {
    try {
      const { data } = await axios.get(
        `${store.baseUrl}/api/users/find-one?telegramId=${id}`
      );
      return data;
    } catch (error) {
      console.error(error);
   ...
   * @returns {userData}
   */
  async updateUserByTgId(telegram_id, payload) {
    try {
      const { data } = await axios.patch(
        `${store.baseUrl}/api/users/${telegram_id}`,
        payload
      );
      return data;
    } catch (error) {
